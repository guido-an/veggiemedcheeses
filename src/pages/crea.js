...
<p className="text"><strong>COORDINATOR and Principal Investigator of CREA-AN</strong><br/>
Dr Pamela Manzi<br/>
Email: pamela.manzi@crea.gov.it<br/>
Skype contact: contact: pamskype3<br/>
Phone: +39 06 51494499
</p>
<img src={pamelaManzi} style={{borderRadius: "50%",  boxShadow:"0px 0px 20px 0px rgba(12,5,5,0.4)"}}/>
<h2 style={{marginTop: "80px"}}>TEAM MEMBERS</h2>
<Divider/>

<div className="team-container" style={{marginTop: "20px"}}>
      <ProfileImg img={mariaDiCostanzo} name="Dr. Maria Di Costanzo" organization="CREA"/>
      <ProfileImg img={nicolettaNardo} name="Nicoletta Nardo" organization="CREA"/>
      <ProfileImg img={paoletti} name="Dr. Flavio Paoletti" organization="CREA"/>
