...
<p className="text"><strong>COORDINATOR and Principal Investigator of D3A-UNIVPM</strong><br/>
...
<img src={luciaAquilanti2} style={{borderRadius: "50%",  boxShadow:"0px 0px 20px 0px rgba(12,5,5,0.4)"}}/>

<h2 style={{marginTop: "80px"}}>TEAM MEMBERS</h2>
<Divider/>

<div className="team-container" style={{marginTop: "20px"}}>
      <ProfileImg img={clementiFrancesca} name="Prof. Francesca Clementi" organization="Università Politecnica delle Marche"/>
      <ProfileImg img={massimoMozzon} name="Prof. Massimo Mozzon" organization="Università Politecnica delle Marche"/>
      <ProfileImg img={nadiaRaffaelli} name="Prof. Nadia Raffaelli" organization="Università Politecnica delle Marche"/>
      </div>
      <div className="team-container" style={{marginTop: "20px"}}>
      <ProfileImg img={andreaOsimani} name="Prof. Andrea Osimani" organization="Università Politecnica delle Marche"/>
      <ProfileImg img={fabioTaffetani} name="Prof. Fabio Taffetani" organization="Università Politecnica delle Marche"/>
      <ProfileImg img={robertoOrsini} name="Prof. Roberto Orsini" organization="Università Politecnica delle Marche"/>
      </div>
      <div className="team-container" style={{marginTop: "20px"}}>
      <ProfileImg img={silviaZitti} name="Prof. Silvia Zitti" organization="Università Politecnica delle Marche"/>
      <ProfileImg img={simonaCasavecchia} name="Prof. Simona Casavecchia" organization="Università Politecnica delle Marche"/>
      <ProfileImg img={zanoli} name="Prof. Raffaele Zanoli" organization="Università Politecnica delle Marche"/>
      </div>
